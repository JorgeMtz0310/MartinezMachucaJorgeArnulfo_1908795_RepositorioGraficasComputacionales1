...
void initScene(Shader ourShader)
{
    ...
    texturePaths[2] = "textures/terrain2.jpg";
    ...
    //:::: POSICIONES DE LUCES DEL EJERCICIO DE ILUMINACION ::::///

    ejercicioIlumPositions.push_back(glm::vec3(0.0f, -0.18f, 0.0f));
    ejercicioIlumPositions.push_back(glm::vec3(5.0f, -0.18f, 0.0f));
    ejercicioIlumPositions.push_back(glm::vec3(-5.2f, -0.18f, 0.0f));

    ejercicioIlumPositions.push_back(glm::vec3(0.0f, 1.1f, 0.0f));
    ejercicioIlumPositions.push_back(glm::vec3(5.0f, 0.66f, 0.0f));
    ejercicioIlumPositions.push_back(glm::vec3(-5.4f, 1.35f, 1.7f));
    ...
    //models.push_back(Model("pedestal1", "models/pedestal/pedestal.obj", glm::vec3(0, -0.18, 0), glm::vec3(0, 90, 0), 0.0f, 0.01));
    //models.push_back(Model("pedestal2", "models/pedestal/pedestal.obj", glm::vec3(5, -0.18, 0), glm::vec3(0, 90, 0), 0.0f, 0.01));
    //models.push_back(Model("pedestal3", "models/pedestal/pedestal.obj", glm::vec3(-5.2, -0.18, 0), glm::vec3(0, 90, 0), 0.0f, 0.01));
    //models.push_back(Model("escultura1", "models/escultura1/escultura1.obj", glm::vec3(0, 1.1, 0), glm::vec3(0, 90, 0), 0.0f, 0.01));
    //models.push_back(Model("escultura2", "models/escultura2/rana.obj", glm::vec3(5, 0.66, 0), glm::vec3(0, 0, 0), 0.0f, 2.5));
    //models.push_back(Model("escultura3", "models/escultura3/escultura3.obj", glm::vec3(-5.4, 1.35, 1.7), glm::vec3(0, 90, 0), 0.0f, initScale * 2));

    modelsIlumination.push_back(Model("pedestal1", "models/pedestal/pedestal.obj", ejercicioIlumPositions[0], glm::vec3(0, 90, 0), 0.0f, 0.01));
    modelsIlumination.push_back(Model("pedestal2", "models/pedestal/pedestal.obj", ejercicioIlumPositions[1], glm::vec3(0, 90, 0), 0.0f, 0.01));
    modelsIlumination.push_back(Model("pedestal3", "models/pedestal/pedestal.obj", ejercicioIlumPositions[2], glm::vec3(0, 90, 0), 0.0f, 0.01));

    modelsIlumination.push_back(Model("escultura1", "models/escultura1/escultura1.obj", ejercicioIlumPositions[3], glm::vec3(0, 90, 0), 0.0f, 0.01));
    modelsIlumination.push_back(Model("escultura2", "models/escultura2/rana.obj", ejercicioIlumPositions[4], glm::vec3(0, 0, 0), 0.0f, 2.5));
    modelsIlumination.push_back(Model("escultura3", "models/escultura3/escultura3.obj", ejercicioIlumPositions[5], glm::vec3(0, 90, 0), 0.0f, initScale * 2));
...
void setMultipleLight(Shader *shader)
{
    ...
    shader->setFloat("plred.linear", 0.09f);
    shader->setFloat("plred.quadratic", 0.032f);
    ...
    shader->setFloat("plgreen.linear", 0.09f);
    shader->setFloat("plgreen.quadratic", 0.032f);
    ...
    shader->setFloat("plblue.linear", 0.09f);
    shader->setFloat("plblue.quadratic", 0.032f);

    //Spot Light
    shader->setVec3("sl.position", 0.0f, 4.0f, 0.0f);
    shader->setVec3("sl.direction", ejercicioIlumPositions[0]);
    ...
    shader->setFloat("sl.linear", 0.09f);
    shader->setFloat("sl.quadratic", 0.032f);
